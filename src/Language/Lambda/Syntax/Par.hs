...
data HappyAbsSyn 
	...
	| HappyAbsSyn9 (Language.Lambda.Syntax.Abs.VarIdent)
	| HappyAbsSyn10 (Language.Lambda.Syntax.Abs.Program)
	| HappyAbsSyn11 (Language.Lambda.Syntax.Abs.Command)
	| HappyAbsSyn12 ([Language.Lambda.Syntax.Abs.Command])
	| HappyAbsSyn13 (Language.Lambda.Syntax.Abs.Term)
	| HappyAbsSyn14 (Language.Lambda.Syntax.Abs.ScopedTerm)
	| HappyAbsSyn15 (Language.Lambda.Syntax.Abs.Pattern)
...
happyExpList = Happy_Data_Array.listArray (0,60) ([0,8,1024,0,2,1552,2048,3,256,32768,0,0,0,0,0,0,0,0,0,33792,1,128,24832,0,4,0,8192,12,0,0,0,0,49664,0,16,0,0,1,3168,0,0,776,0,0,0,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_pProgram","%start_pCommand","%start_pListCommand","%start_pTerm","%start_pScopedTerm","%start_pPattern","VarIdent","Program","Command","ListCommand","Term","ScopedTerm","Pattern","'('","')'","'.'","';'","'compute'","'\955'","L_VarIdent","%eof"]
...
action_3 (13) = happyGoto action_15
...
action_11 (13) = happyGoto action_24
...
action_14 (15) = happyGoto action_25
...
happyReduction_12 ((HappyAbsSyn14  happy_var_4) `HappyStk`
	_ `HappyStk`
...
happyNewToken action sts stk (tk:tks) =
	...
	PT _ (TS _ 5) -> cont 20;
	PT _ (TS _ 6) -> cont 21;
	PT _ (T_VarIdent happy_dollar_dollar) -> cont 22;
	_ -> happyError' ((tk:tks), [])
	}
...
pScopedTerm tks = happySomeParser where
 happySomeParser = happyThen (happyParse action_4 tks) (\x -> case x of {HappyAbsSyn14 z -> happyReturn z; _other -> notHappyAtAll })
