...
instance Print Language.Lambda.Syntax.Abs.UnificationProblem where
  prt i = \case
    Language.Lambda.Syntax.Abs.AUnificationProblem varidents scopedterm1 scopedterm2 -> prPrec i 0 (concatD [doc (showString "\8704"), prt 0 varidents, doc (showString "."), prt 0 scopedterm1, doc (showString "="), prt 0 scopedterm2])
